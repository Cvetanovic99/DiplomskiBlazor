...
public partial class PopularProvidersSection : ComponentBase
{
    [Inject] protected NavigationManager Navigation { get; set; } = default!;

    protected List<ProviderGroup> ProviderGroups { get; set; } = [];
    ...
    protected override void OnInitialized()
    {
        ...
        [
            new ProviderGroup
            {
                ...
                Providers =
                [
                    new ProviderCard { Id = "salon-bella", Name = "Salon Bella", Address = "Nis, Bulevar Nemanjica 24", Rating = 4.9m, IsCompany = true, Description = "Moderan frizerski salon za zene, muskarce i decu sa fokusom na negu i stilizovanje.", ImageUrl = "/images/hero-hairdresser.jpg" },
                    ...
                    new ProviderCard { Id = "marko-styling", Name = "Marko Styling", Address = "Novi Sad, Jevrejska 8", Rating = 4.7m, IsCompany = false, Description = "Muski frizer specijalizovan za moderne fade frizure i precizno oblikovanje brade.", ImageUrl = "/images/providers/marko-styling.jpg" },
            ...
            new ProviderGroup
            {
                ...
                [
                    ...
                    new ProviderCard { Id = "brzi-servis", Name = "Brzi Servis", Address = "Novi Sad, Detelinara", Rating = 4.8m, IsCompany = true, Description = "Kucne popravke i razne intervencije za stanove, kuce i poslovne prostore.", ImageUrl = "/images/providers/brzi-servis.jpg" },
    ...
    protected IEnumerable<List<ProviderCard>> ChunkProviders(List<ProviderCard> providers, int size)
    {
    ...
    protected void NavigateToProvider(ProviderCard provider)
    {
        var url = provider.IsCompany
            ? $"/companies/{provider.Id}"
            : $"/providers/{provider.Id}";

        Navigation.NavigateTo(url);
    }

    protected string GetStarsFillStyle(decimal rating)
    {
        var percentage = Math.Clamp((double)(rating / 5m) * 100d, 0d, 100d);
